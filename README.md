...
- **Machine-assisted formal reasoning** — I contribute to [TLAPS-Bench](https://github.com/specula-org/tlaps-bench), a benchmark for evaluating AI systems on completing and constructing machine-checkable TLA+ proofs.
- **AI agents for software reliability** — I contribute to [SREGym](https://github.com/SREGym/SREGym), an AI-native platform for developing and evaluating SRE agents on realistic cloud-system failures. My work includes reproducible Kubernetes incidents that test diagnosis and safe recovery under degraded observability.
